...
!function (m) {
	...
	if (VRenabled && navigator.getVRDisplays) {
		navigator.getVRDisplays().then(function (props) {
			if (props.length > 0) {
				...
				jQHeader.html("<img src='img/missing-headset.png'>Your browser supports WebVR, but we couldn't find your headset. Falling back to non-VR mode.");
				init();
			}
	...
	Collection.inherit(obj, {
		...
		selectObjectVR: function (name) {
			...
			camera.scale.set(85e-5, 85e-5, 85e-5);
